...
public class ChildSubcategoryPKConverter implements BackendIdConverter {
    ...
    public String toRequestId(Serializable id, Class<?> entityType) {
        ChildSubcategory.PK childSubcategoryPk = (ChildSubcategory.PK) id;
        return childSubcategoryPk.getChild().getChildId() + "|" + childSubcategoryPk.getSubcategory().getSubcategoryId();
